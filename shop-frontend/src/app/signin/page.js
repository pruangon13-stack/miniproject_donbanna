...
export default function Signin() { //ฟังก์ชั่นคอมโพเนนต์ ชื่อว่า signin 
    ...
    return (
        <Container className="d-flex justify-content-center align-items-center" style={{ minHeight: '70vh' }}> //จัดอยู่ตรงกลางทั้งแนวตั้งและแนวนอน
            <Card className="shadow-lg border-0" style={{ width: '100%', maxWidth: '450px', borderRadius: '15px' }}> //ลบขอบ ปรับมุม
                <Card.Header className="bg-transparent border-0 pt-4"> //cart header และ nev เป็นส่วนหัวและการสลับหน้าจอ
                ...
                <Card.Body className="px-4 pb-5"> //cart body คือส่วนของที่แบบฟอร์มที่ตั้องให้ผู้ใช้กหรอก
